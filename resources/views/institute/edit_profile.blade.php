<x-admin-layout>
    <div class="container px-6 mx-auto grid">
      ...
      <form method="POST" action="{{ route('institute.profile.update',$edit_data->id) }}" enctype="multipart/form-data">
        @csrf
        <!-- Full Name -->
        ...
        <div>
            ...
            <x-input id="institute_name" class="block mt-1 w-full" type="text" name="institute_name" value="{{ $edit_data->institute_name }}" required autofocus />
        </div>
