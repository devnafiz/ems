<x-admin-layout>
    <div class="container px-6 mx-auto grid">
      <h2
        class="my-6 text-center text-2xl font-semibold text-gray-700 dark:text-gray-200"
      >
      Edit Student
      </h2>
      <!-- General elements -->
      ...
      <form method="POST" action="{{ route('admin.student.update',$edit_data->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- Full Name -->
