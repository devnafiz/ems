            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                              @if ($students->health_declaration_file &&
                                                    file_exists(public_path('uploads/health/' . $students->health_declaration_file)))
                            <a href="{{ asset('uploads/health') }}/{{ $students->health_declaration_file }}" download>download</a>
                             @else
                                <h6><span class="badge badge-danger">no file</span></h6>
                             @endif
                    ...
                    <tr>
                        ...
                        <td>
                             @if ($students->passport_scanned_file &&
                                                    file_exists(public_path('uploads/passport/' . $students->passport_scanned_file)))
                            <a href="{{ asset('uploads/passport') }}/{{ $students->passport_scanned_file }}" download>download</a>
                    ...
                    <tr>
                        ...
                        <td>
                              @if ($students->academic_certificate_file_1 &&
                                                    file_exists(public_path('uploads/certificates/' . $students->academic_certificate_file_1)))
                            <a href="{{ asset('uploads/certificates') }}/{{ $students->academic_certificate_file_1 }}" download>download</a>
                             @else
                                <h6><span class="badge badge-danger">no file</span></h6>
                             @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                              @if ($students->academic_certificate_file_1 &&
                                                    file_exists(public_path('uploads/certificates/' . $students->academic_certificate_file_2)))
                            <a href="{{ asset('uploads/certificates') }}/{{ $students->academic_certificate_file_2 }}" download>download</a>
                             @else
                                <h6><span class="badge badge-danger">no file</span></h6>
                             @endif
                        </td>
