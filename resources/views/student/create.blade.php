    ...
    <div class="container px-6 mx-auto grid">
      ...
      <form method="POST" action="{{ route('student.registration.store') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-input id="passport_number" class="block mt-1 w-full" type="text" name="passport_number" :value="old('passport_number')" required autofocus />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-input id="subject_name" class="block mt-1 w-full" type="text" name="subject_name" :value="old('subject_name')" required autofocus />
        </div>
